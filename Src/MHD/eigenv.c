 ...
 * \param [out]  cs2  1-D array containing the square of the sound speed
...
#define  sqrt_1_2  (0.70710678118654752440)
{
  ...
  #if EOS == BAROTROPIC
   print ("! EIGENV: not defined for barotropic MHD\n");
   QUIT_PLUTO(1);
  #endif
...
/* ----------------------------------------------------------
  ...
  #if EOS == BAROTROPIC
   print ("! C_EIGENV: not defined for barotropic MHD\n");
   QUIT_PLUTO(1);
  #endif
